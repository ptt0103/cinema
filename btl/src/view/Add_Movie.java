...
public class Add_Movie extends javax.swing.JFrame {
     ...
     */
    public Add_Movie() throws SQLException {
        initComponents();
...
//        getNameMovie();
    ...
    public void addMovie(){
        String nameMovie = JName.getText();
        String country = JTitle.getText();
        String duration = JPrice.getText();
        String query = "INSERT INTO `movie`(`TITILE`, `COUNTRY`, `DURATION`) VALUES ('" + nameMovie + "','" + country + "','" + Integer.parseInt(duration) + "')";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Thêm thông tin phim");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(JName, javax.swing.GroupLayout.DEFAULT_SIZE, 499, Short.MAX_VALUE)
                            .addComponent(JTitle)
                            .addComponent(JPrice))
